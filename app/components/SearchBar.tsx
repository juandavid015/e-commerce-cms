...
export const SearchBar = () => {
    ...
    return (
        ...
        transition-all duration-700 z-[900] rounded absolute top-0 left-0 
        ...
        >
            <form action="./search/"
                ...
                bg-white-gray rounded-md py-2 px-4 ${expanded ? 'w-full': 'md:w-[calc(100%-216px)] w-[calc(100%-116px)] ' }
